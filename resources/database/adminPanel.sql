...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-08-2017 a las 12:14:25
...
(0000000001, 'Test', 'Test', 'Test', 'Terminado', 1);
...
CREATE TABLE `slider` (
  ...
  `ALT` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci NOT NULL,
...
INSERT INTO `slider` (`ID`, `Nombre`, `URL`, `Titulo`, `Descripcion`, `ALT`, `Estado`) VALUES
(0000000016, '13835616_10208766191184876_518247480_o (1).jpg', '../../../public/img/13835616_10208766191184876_518247480_o (1).jpg', 'asdadsa', 'asdasdsa', 'asdas', 1);
